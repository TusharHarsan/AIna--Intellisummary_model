        ...
        <div class="relative z-10 bg-gray-900/70 px-6 py-4 shadow-xl border-b border-blue-900">
          <div class="container mx-auto flex items-center justify-between">
            ...
            <div class="flex items-center space-x-3">
              <img src="./Picture1.png" alt="Logo" class="h-12 w-auto" />
            </div>
            <div class="text-center mx-auto px-4 font-extrabold">
              <h5 class="text-2xl md:text-3xl font-extrabold text-blue-300 leading-snug">
              Ai Summarization
              </h5>
